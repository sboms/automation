                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                      ...
                      <tr>
                        <th>{{ $i++ }}</th>
                        <td>{{ $vacation->name }}</td>
                        <td>{{ $vacation->maxday }}</td>
                        <td>{{ $vacation->maxdayinyear }}</td>
                        <td>{{ $vacation->repetition }}</td>
                        <td>{{ $vacation->salarydeduction }}</td>
                        <td>{{ $vacation->recompense }}</td>

                        <td>
                            {{--  <a href="{{ route('specialty.residents', ['specialty' => $vacation->id]) }}">
                                <button type="button" class="btn btn-outline-success  btn-lg" data-toggle="modal" data-backdrop="false" data-target="#info">
                                    المقيمين
                                </button>
                            </a>  --}}
                            <a href="{{ route('vacation.edit',['vacation'=>$vacation->id]) }}">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ route('vacation.destroy',['vacation' => $vacation->id]) }}" method="post">
                                                        @csrf
                                                        @method("DELETE")
