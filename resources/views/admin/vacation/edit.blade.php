            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">تعديل تعديل معلومات إجازة</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <div class="card-text">
                                <p>يرجى الانتباه إلى إن تعديل الإجازة يعود على كافة أقسام النظام</p>
                            </div>
                            <form class="form" action="{{ route('vacation.update',['vacation' => $vacation->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" name="name" value="{{ $vacation->name }}" class="form-control" placeholder="نوع الإجازة ">
                                                @error("name")
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="1" id="maxday" name="maxday" value="{{ $vacation->maxday }}" class="form-control" placeholder="عدد الأيام الأعظمي للإجازة الواحدة ">
                                                @error("maxday")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="1" id="maxdayinyear" name="maxdayinyear" value="{{ $vacation->maxdayinyear }}" class="form-control" placeholder="عدد الأيام المسموح به بالنسة ">
                                                @error("maxdayinyear")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group"><br>
                                                ...
                                                <input type="checkbox" id="switcherySize1" name="recompense" class="switchery" {{ $vacation->recompense == 'محتسبة' ? 'checked' :'' }} />
                                                @error("recompense")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group"><br>
                                                ...
                                                <input type="checkbox" id="switcherySize1" name="salarydeduction" class="switchery" {{ $vacation->salarydeduction == 'مدفوعة' ? 'checked' :'' }} />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group"><br>
                                                ...
                                                <input type="checkbox" id="switcherySize1" name="repetition" class="switchery" {{ $vacation->repetition == 'مكررة' ? 'checked' :'' }} />
                                                @error("repetition")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
