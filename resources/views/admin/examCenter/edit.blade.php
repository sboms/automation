            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form"> إضافة مركز امتحاني </h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" action="{{ route('examCenter.update',['examCenter'=>$examCenter->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $examCenter->name }}" id="name" name="name" class="form-control" placeholder="">
                                                @error("name")
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $examCenter->place }}" id="place" name="place" class="form-control" placeholder="">
                                                @error("place")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select form-control" id="location2" name="type">
                                                    ...
                                                    <option value="مكتب" {{ $examCenter->type == "مكتب" ? "selected" : "" }}>مكتب</option>
                                                    <option value="مشفى" {{ $examCenter->type == "مشفى" ? "selected" : "" }}>مشفى</option>
                                                    <option value="مستوصف" {{ $examCenter->type == "مستوصف" ? "selected" : "" }}>مستوصف</option>
                                                    <option value="zoom" {{ $examCenter->type == "zoom" ? "selected" : "" }}>zoom</option>
                                                </select>
                                                @error("type")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
