                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('specialty.residents', ['specialty' => $specialty->id]) }}" target="_blank">
                                            <button type="button" class="btn btn-outline-info  btn-lg" data-toggle="modal" data-backdrop="false" data-target="#info">
                                                المقيمين
                                            </button>
                                        </a>
                                        <a href="{{ route('specialty.finished', ['specialty' => $specialty->id]) }}" target="_blank">
                                            <button type="button" class="btn btn-outline-amber  btn-lg" data-toggle="modal" data-backdrop="false" data-target="#info">
                                                أنهى التدريب
                                            </button>
                                        </a>
                                        <a href="{{ route('specialty.graduates', ['specialty' => $specialty->id]) }}" target="_blank">
                                            <button type="button" class="btn btn-outline-success  btn-lg" data-toggle="modal" data-backdrop="false" data-target="#info">
                                                خرجين
                                            </button>
                                        </a>
                                        <a href="{{ route('specialty.other', ['specialty' => $specialty->id]) }}" target="_blank">
                                            <button type="button" class="btn btn-outline-danger  btn-lg" data-toggle="modal" data-backdrop="false" data-target="#info">
                                                غير ذلك
                                            </button>
                                        </a>
                                    </td>
