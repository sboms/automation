                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group mr-1 mb-1">
                                            <a href="{{ route('residenceYear.index', ['resident' => $resident->id, 'specialty' => $specialty->id]) }}">
                                                <button type="button" class="btn btn-outline-primary">سنوات
                                                    الإقامة</button>
                                            </a>
                                        </div>
                                        <div class="btn-group mr-1 mb-1">
                                        ...
                                        <div class="btn-group mr-1 mb-1">
                                            <a href="{{ route('state.index',['resident' =>$resident ,'specialty'=>$specialty]) }}">
                                                <button type="button" class="btn btn-outline-primary">الحالة</button>
                                            </a>
                                        </div>
                                        <div class="btn-group mr-1 mb-1">
