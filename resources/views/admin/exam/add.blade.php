            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">إضافة امتحان</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" action="{{ route('exam.store') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select form-control" id="location2" name="name" required>
                                                    <option value="">اختر نوع الامتحان</option>
                                                    <option value="كتابي أولي">كتابي أولي</option>
                                                    <option value="كتابي نهائي">كتابي نهائي</option>
                                                    <option value="سريري وشفوي">سريري وشفوي</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="exam_date" name="exam_date" class="form-control" placeholder="" required>
                                                @error("exam_date")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select form-control" id="location2" name="cycle" required>
                                                    <option value="">اختر الدورة الامتحانية*</option>
                                                    @foreach($cycles as $cycle)
                                                    <option value="{{ $cycle->id }}">{{ $cycle->type }} {{ $cycle->year }}</option>
                                                    @endforeach
                                                </select>
                                                @error("cycle")
                                                <span class="text-danger">{{$message}}</span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select form-control" id="location2" name="specialty" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-control" id="location2" multiple="multiple" name="examCenters[]" required>
                                ...
                                <a href="{{ route('exam.index') }}">العودة إلى جميع الامتحانات</a>
                            </form>
                        </div>
                    </div>
                </div>
