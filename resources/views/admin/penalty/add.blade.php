            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">إضافة عقوبة</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <div class="card-text">
                                <p>يرجى مراعاة شروط السياسات عند إضافة عقوبة</p>
                            </div>
                            <form class="form" action="{{ route('penalty.store') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" name="name" class="form-control" placeholder="اسم العقوبة ">
                                                @error("name")
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="count" name="count" class="form-control" placeholder="عدد مرات تكرار العقوبة ">
                                                @error("count")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group"><br>
                                                ...
                                                <input type="checkbox" id="switcherySize1" name="residence_effect" class="switchery" checked />
