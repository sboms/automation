                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" action="{{ route('vacationResident.update',['resident'=>$resident->id,'specialty'=>$specialty->id,'vacation'=>$cuVacation->id]) }}" method="POST">
                                @csrf
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select form-control" id="location2" name="vacation" required>
                                                    ...
                                                    <option value={{ $vacation->id }} {{ $vacation->id==$cuVacation->id ? "selected" : "" }}>{{ $vacation->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error("status")
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="start" value="{{ $reVacation->start }}" name="start" class="form-control" placeholder="تاريخ البداية " required>
                                                @error("start")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="end" value="{{ $reVacation->end }}" name="end" class="form-control" placeholder="تاريخ النهاية" required>
                                                @error("end")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
