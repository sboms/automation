            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">إضافة عقوبة لمقيم</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <div class="card-text">
                                <p>إضافة عقوبة للمقيم {{ $resident->User->name }} {{ $resident->User->last_name }} في اختصاص {{ $specialty->name }}</p>
                            </div>
                            <form class="form" action="{{ route('penaltyResident.store',['resident'=>$resident,'specialty'=>$specialty]) }}" method="POST">
                                @csrf
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="eventName2">اختر نوع العقوبة :</label>
                                                <select class="custom-select form-control" id="location2" name="penalty" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="reason" name="reason" class="form-control" placeholder="تاريخ النهاية" required>
                                                @error("reason")
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <a href="{{ route('penaltyResident.index',['resident'=>$resident->id,'specialty'=>$specialty->id]) }}">العودة إلى كل عقوبات المقيم</a>
                            </form>
                        </div>
                    </div>
                </div>
