                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-form"> تعديل معلومات دورة امتحانية </h4>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <form class="form" action="{{ route('cycle.update', ['cycle' => $cycle->id]) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select form-control" id="location2"
                                                        ...
                                                        <option value="أولى"
                                                            {{ $cycle->type == 'أولى' ? 'selected' : '' }}>أولى</option>
                                                        <option
                                                            value="ثانية"{{ $cycle->type == 'ثانية' ? 'selected' : '' }}>
                                                            ثانية</option>
                                                    </select>
                                                    @error('type')
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="year">
                                                        @for ($year = ((int) date('Y')) + 2; 1900 <= $year; $year--)
                                                            :
                                                            <option value="{{ $year }}" {{ $cycle->year ==  $year ? "selected" : ""}}>{{ $year }}
                                                            </option>
                                                        @endfor
                                                    </select>
                                                    @error('year')
                                    ...
                                    <a href="{{ route('cycle.index') }}">العودة إلى كل الدورات الامتحانية</a>
                                </form>
                            </div>
                        </div>
                    </div>
